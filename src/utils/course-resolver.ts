// =============================================================================
// EDS HUB — Central Course Interest Resolver
// =============================================================================
...
export function resolvePrioritizedCourseInterests(
  ...
  // 1.1 curso_de_interesse (HubSpot)
  // 1.2 form_name (Meta / Website Form)
  // 1.3 campaign_name
  // 1.4 course_interest generic
