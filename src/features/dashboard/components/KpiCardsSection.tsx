    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
      ...
      <div className="bg-white rounded-2xl border border-slate-200/90 p-5 shadow-xs hover:shadow-md transition-all relative overflow-hidden group">
        ...
        <p className="text-[11px] text-slate-400 mt-1">
          Total no CRM: <span className="font-semibold text-slate-700">{snapshot.total_leads}</span>
        </p>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200/90 p-5 shadow-xs hover:shadow-md transition-all relative overflow-hidden group">
        ...
        <p className="text-[11px] text-slate-400 mt-1">
          Threshold: <span className="font-semibold text-slate-700">≥{scoring.thresholds.hot_min} pts</span>
        </p>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200/90 p-5 shadow-xs hover:shadow-md transition-all relative overflow-hidden group">
        ...
        <div className="flex items-baseline gap-2 mt-1">
          <span className="text-2xl font-extrabold text-[#08254f] font-heading tracking-tight">{tasks.due_today}</span>
          {tasks.overdue > 0 && (
        ...
        <p className="text-[11px] text-slate-400 mt-1">
          Pendentes totais: <span className="font-semibold text-slate-700">{tasks.pending_tasks}</span>
        </p>
      </div>
    </div>
  );
