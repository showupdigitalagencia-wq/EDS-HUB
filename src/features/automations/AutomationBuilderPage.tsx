    ...
    <Layout title="Automation Builder">
      <div className="max-w-4xl mx-auto space-y-6 pb-20">
        ...
        <div className="flex items-center justify-between">
            ...
            <div>
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="text-xl font-bold text-gray-900 border-b border-transparent hover:border-gray-300 focus:border-brand-500 focus:outline-none px-1 py-0.5"
                />
                <span
              ...
              <input
                ...
                className="text-xs text-gray-500 border-b border-transparent hover:border-gray-200 focus:border-brand-300 focus:outline-none w-full px-1 mt-0.5"
              />
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 text-xs font-semibold text-gray-700 bg-white border border-gray-200 hover:bg-gray-50 rounded-xl shadow-2xs transition-colors"
            >
            ...
            <button
              ...
              disabled={isSaving}
              className="flex items-center gap-1.5 px-3.5 py-2 text-xs font-semibold text-gray-700 bg-white border border-gray-200 hover:bg-gray-50 rounded-xl shadow-2xs disabled:opacity-50 transition-colors"
            >
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-2xl border-2 border-brand-500/80 shadow-xs p-6 relative overflow-hidden">
            ...
            return (
              <div key={step.id || idx} className="space-y-3">
                ...
                <div className="flex justify-center">
                  <div className="w-0.5 h-6 bg-gray-200 relative flex items-center justify-center">
